...
a <- read_excel("D:/Google 云端硬盘/2017-Fall-Gazetteer/Data Analysis/Group Progress/Jinming/unit_list/Area.xlsx",col_types = "text", col_names = TRUE)
b <- read_excel("D:/Google 云端硬盘/2017-Fall-Gazetteer/Data Analysis/Group Progress/Jinming/unit_list/Amount.xlsx",col_types = "text", col_names = TRUE)
c <- read_excel("D:/Google 云端硬盘/2017-Fall-Gazetteer/Data Analysis/Group Progress/Jinming/unit_list/OutputValue.xlsx",col_types = "text", col_names = TRUE)
d <- read_excel("D:/Google 云端硬盘/2017-Fall-Gazetteer/Data Analysis/Group Progress/Jinming/unit_list/Percentage.xlsx",col_types = "text", col_names = TRUE)
e <- read_excel("D:/Google 云端硬盘/2017-Fall-Gazetteer/Data Analysis/Group Progress/Jinming/unit_list/EnginePower.xlsx",col_types = "text", col_names = TRUE)
f <- read_excel("D:/Google 云端硬盘/2017-Fall-Gazetteer/Data Analysis/Group Progress/Jinming/unit_list/Person.xlsx",col_types = "text", col_names = TRUE)
g <- read_excel("D:/Google 云端硬盘/2017-Fall-Gazetteer/Data Analysis/Group Progress/Jinming/unit_list/Areaperperson.xlsx",col_types = "text", col_names = TRUE)
h <- read_excel("D:/Google 云端硬盘/2017-Fall-Gazetteer/Data Analysis/Group Progress/Jinming/unit_list/Car.xlsx",col_types = "text", col_names = TRUE)
k <- read_excel("D:/Google 云端硬盘/2017-Fall-Gazetteer/Data Analysis/Group Progress/Jinming/unit_list/Animal.xlsx",col_types = "text", col_names = TRUE)
